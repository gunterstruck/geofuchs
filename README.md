...
| 🦊 **Mein Tag** | Ein Klick plant die Tagestour automatisch aus fälligen/überfälligen Kunden (überfällige zuerst, Route optimiert). Datum, Startzeit und Besuchsdauer (z. B. 45 min) sind einstellbar und fließen in Tagesplan-Druck und Kalender-Termine (.ics für Outlook) ein |
